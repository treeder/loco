...
A JavaScript localization library, inspired by [@lit/localize](https://lit.dev/docs/localization/overview/), but for server side rendering. And you can use the same file for both the server side and client side! :boom: 
